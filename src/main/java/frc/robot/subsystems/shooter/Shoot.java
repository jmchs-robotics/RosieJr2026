...
public class Shoot extends SubsystemBase {
  ...
  private final ShootIOInputsAutoLogged inputs;

  public Shoot(ShootIO io, Drive drive) {

    this.io = io;
    this.drive = drive;
    inputs = new ShootIOInputsAutoLogged();
  ...
  public void periodic() {
    ...
    shooterAlert.set(!inputs.shootIsConnected);
  }
  ...
  public double calculateSpeed() {
    ...
    double velocity = (21 + 15 * ((shooterToHub - 4.1) / 13.2)) * 1.047 * 5.75 * 8.9;
