...
public class MovingAutoAimCalcs {
    ...
    public static Translation2d getOffset(double velocityX, double velocityY, Translation2d currentTranslation, Translation2d targetTranslation) {

        double time0 = 0;
        Translation2d translation0 = targetTranslation;

        double time1 = flightTimeMap.get(distance(translation0, currentTranslation));
        Translation2d translation1 = translation0.plus(
            new Translation2d(
                -velocityX * time1,
                -velocityY * time1
            )
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            time1 = newFlightTime;
            translation1 = targetTranslation.plus(
                new Translation2d(
                    -velocityX * newFlightTime,
                    -velocityY * newFlightTime
                )
            );
